...
flowchart TD
    ...
    S["<b>Business logic</b> — internal/service (+ sub-packages)<br/>All domain rules, validation, calculations, orchestration<br/>Owns ownership checks, sentinel errors<br/>Sub-engines: currency/, flightcalc/, flightrules/, cloudbackup/, customreport/"]
...
flowchart TD
    ...
    SVC --> SUB["service/currency · service/flightcalc · service/flightrules · service/customreport<br/>service/cloudbackup (+provider/{s3,sftp,webdav})"]
```
