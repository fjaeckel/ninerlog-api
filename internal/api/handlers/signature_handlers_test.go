...
func setupSignatureTestHandlerSharedRepo(t *testing.T) (h *APIHandler, userID uuid.UUID, flight *models.Flight) {
	...
	h = &APIHandler{
		authService:            service.NewAuthService(userRepo, newHandlerMockRefreshTokenRepo(), &mockPasswordResetRepo{}, &mockEmailVerificationRepo{}, jwtMgr, service.NewTwoFactorService(userRepo, jwtMgr, handlerTestTOTPAEAD(t))),
