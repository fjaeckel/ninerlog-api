...
func (h *APIHandler) GetLicenseStatistics(c *gin.Context, licenseId generated.LicenseId, params generated.GetLicenseStatisticsParams) {
	...
	statistics := generated.Statistics{
		...
		SicMinutes:          ptrInt(stats.SICMinutes),
		DualGivenMinutes:    ptrInt(stats.DualGivenMinutes),
		PicusMinutes:        ptrInt(stats.PICUSMinutes),
		SpicMinutes:         ptrInt(stats.SPICMinutes),
		ExaminerMinutes:     ptrInt(stats.ExaminerMinutes),
		ReliefMinutes:       ptrInt(stats.ReliefMinutes),
