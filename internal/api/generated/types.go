...
const (
	...
	FlightLaunchMethodAutoTow    FlightLaunchMethod = "auto-tow"
...
func (e FlightLaunchMethod) Valid() bool {
	...
	case FlightLaunchMethodAerotow:
		return true
	case FlightLaunchMethodAutoTow:
		return true
...
// Defines values for FlightReleaseAltitudeRef.
const (
	FlightReleaseAltitudeRefAGL  FlightReleaseAltitudeRef = "AGL"
	FlightReleaseAltitudeRefAMSL FlightReleaseAltitudeRef = "AMSL"
)

// Valid indicates whether the value is a known member of the FlightReleaseAltitudeRef enum.
func (e FlightReleaseAltitudeRef) Valid() bool {
	switch e {
	case FlightReleaseAltitudeRefAGL:
		return true
	case FlightReleaseAltitudeRefAMSL:
		return true
	default:
		return false
	}
...
const (
	...
	FlightCreateLaunchMethodAutoTow    FlightCreateLaunchMethod = "auto-tow"
...
func (e FlightCreateLaunchMethod) Valid() bool {
	...
	case FlightCreateLaunchMethodAerotow:
		return true
	case FlightCreateLaunchMethodAutoTow:
		return true
...
// Defines values for FlightCreateReleaseAltitudeRef.
const (
	FlightCreateReleaseAltitudeRefAGL  FlightCreateReleaseAltitudeRef = "AGL"
	FlightCreateReleaseAltitudeRefAMSL FlightCreateReleaseAltitudeRef = "AMSL"
)

// Valid indicates whether the value is a known member of the FlightCreateReleaseAltitudeRef enum.
func (e FlightCreateReleaseAltitudeRef) Valid() bool {
	switch e {
	case FlightCreateReleaseAltitudeRefAGL:
		return true
	case FlightCreateReleaseAltitudeRefAMSL:
		return true
	default:
		return false
	}
...
const (
	...
	AutoTow    FlightUpdateLaunchMethod = "auto-tow"
	Bungee     FlightUpdateLaunchMethod = "bungee"
...
// Defines values for FlightUpdateReleaseAltitudeRef.
const (
	AGL  FlightUpdateReleaseAltitudeRef = "AGL"
	AMSL FlightUpdateReleaseAltitudeRef = "AMSL"
)

// Valid indicates whether the value is a known member of the FlightUpdateReleaseAltitudeRef enum.
func (e FlightUpdateReleaseAltitudeRef) Valid() bool {
	switch e {
	case AGL:
		return true
	case AMSL:
...
const (
	...
	ExportFlightsPDFParamsFormatGlider  ExportFlightsPDFParamsFormat = "glider"
...
func (e ExportFlightsPDFParamsFormat) Valid() bool {
	...
	case ExportFlightsPDFParamsFormatFaa:
		return true
	case ExportFlightsPDFParamsFormatGlider:
		return true
...
type Flight struct {
	...
	// LaunchMethod Launch method for glider/SPL flights (winch, aerotow, self-launch, bungee, or auto-tow)
	LaunchMethod *FlightLaunchMethod `json:"launchMethod,omitempty"`

	// Launches Number of launches on this flight (EASA FCL.140.S). Defaults to 1 for glider flights; a club training row may chain several launches in one entry. 0 for powered flights.
	...
	// ReleaseAltitude Release / cable-break altitude in metres for winch and aerotow launches.
	ReleaseAltitude *int `json:"releaseAltitude,omitempty"`

	// ReleaseAltitudeRef Reference datum for releaseAltitude (above ground level or above mean sea level).
	ReleaseAltitudeRef *FlightReleaseAltitudeRef `json:"releaseAltitudeRef,omitempty"`
...
// FlightLaunchMethod Launch method for glider/SPL flights (winch, aerotow, self-launch, bungee, or auto-tow)
type FlightLaunchMethod string

// FlightReleaseAltitudeRef Reference datum for releaseAltitude (above ground level or above mean sea level).
type FlightReleaseAltitudeRef string
...
type FlightCreate struct {
	...
	// Launches Number of launches on this flight (EASA FCL.140.S). Defaults to 1 for glider flights, 0 for powered flights.
	Launches *int `json:"launches,omitempty"`
	...
	// ReleaseAltitudeRef Reference datum for releaseAltitude (AGL or AMSL).
	ReleaseAltitudeRef *FlightCreateReleaseAltitudeRef `json:"releaseAltitudeRef,omitempty"`
	Remarks            *string                         `json:"remarks,omitempty"`
...
// FlightCreateReleaseAltitudeRef Reference datum for releaseAltitude (AGL or AMSL).
type FlightCreateReleaseAltitudeRef string
...
type FlightUpdate struct {
	...
	// Launches Number of launches on this flight (EASA FCL.140.S)
	Launches *int `json:"launches,omitempty"`
	...
	// ReleaseAltitudeRef Reference datum for releaseAltitude (AGL or AMSL).
	ReleaseAltitudeRef *FlightUpdateReleaseAltitudeRef `json:"releaseAltitudeRef,omitempty"`
	Remarks            *string                         `json:"remarks,omitempty"`
...
// FlightUpdateReleaseAltitudeRef Reference datum for releaseAltitude (AGL or AMSL).
type FlightUpdateReleaseAltitudeRef string
...
type ExportFlightsPDFParams struct {
	...
	// Format PDF format — easa (AMC1 FCL.050 two-page spread), faa (ASA/Jeppesen layout), glider (EASA SPL sailplane logbook with launch columns), or summary (simplified totals)
