...
const (
	...
	ExportFlightsCSVParamsFormatGlider   ExportFlightsCSVParamsFormat = "glider"
...
type Flight struct {
	...
	ReleaseAltitude *int `json:"releaseAltitude"`

	// ReleaseAltitudeRef Reference datum for releaseAltitude (above ground level or above mean sea level).
	ReleaseAltitudeRef *FlightReleaseAltitudeRef `json:"releaseAltitudeRef"`
...
type FlightCreate struct {
	...
	ReleaseAltitudeRef *FlightCreateReleaseAltitudeRef `json:"releaseAltitudeRef"`
	Remarks            *string                         `json:"remarks"`
...
type FlightUpdate struct {
	...
	// ReleaseAltitudeRef Reference datum for releaseAltitude (AGL or AMSL).
	ReleaseAltitudeRef *FlightUpdateReleaseAltitudeRef `json:"releaseAltitudeRef"`
	Remarks            *string                         `json:"remarks"`
