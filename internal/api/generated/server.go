...
type ServerInterface interface {
	...
	// ListAdminAuditLog List admin audit log
	// (GET /admin/audit-log)
	...
	// TriggerNotifications Trigger notification check
	...
	// GetAircraft Get aircraft details
	...
	// GetAirport Get airport coordinates
	// (GET /airports/{icaoCode})
	GetAirport(c *gin.Context, icaoCode string)
	// GetAnnouncements Get active announcements and user hints
	// (GET /announcements)
	GetAnnouncements(c *gin.Context)
	// Disable2FA Disable 2FA
	// (POST /auth/2fa/disable)
	Disable2FA(c *gin.Context)
	// Login2FA Complete login with 2FA code
	// (POST /auth/2fa/login)
	...
	// ResendVerificationEmail Resend the email-verification message
	// (POST /auth/verify-email/resend)
	ResendVerificationEmail(c *gin.Context)
	// ListWebauthnCredentials List the current user's passkeys
	// (GET /auth/webauthn/credentials)
	ListWebauthnCredentials(c *gin.Context)
	// DeleteWebauthnCredential Revoke a passkey
	// (DELETE /auth/webauthn/credentials/{credentialId})
	DeleteWebauthnCredential(c *gin.Context, credentialId openapi_types.UUID)
	// WebauthnLoginOptions Begin passkey login
	// (POST /auth/webauthn/login/options)
	WebauthnLoginOptions(c *gin.Context)
	// WebauthnLoginVerify Verify passkey assertion and sign in
	// (POST /auth/webauthn/login/verify)
	WebauthnLoginVerify(c *gin.Context)
	// WebauthnRegisterOptions Begin passkey registration
	// (POST /auth/webauthn/register/options)
	WebauthnRegisterOptions(c *gin.Context)
	// WebauthnRegisterVerify Verify passkey registration attestation
	// (POST /auth/webauthn/register/verify)
	WebauthnRegisterVerify(c *gin.Context)
	// ListBackupDestinations List the user's backup destinations
	// (GET /backups/destinations)
	ListBackupDestinations(c *gin.Context)
	// CreateBackupDestination Create a backup destination
	// (POST /backups/destinations)
	CreateBackupDestination(c *gin.Context)
	// DeleteBackupDestination Delete a backup destination
	// (DELETE /backups/destinations/{destinationId})
	DeleteBackupDestination(c *gin.Context, destinationId BackupDestinationId)
	// GetBackupDestination Get a backup destination
	// (GET /backups/destinations/{destinationId})
	GetBackupDestination(c *gin.Context, destinationId BackupDestinationId)
	// UpdateBackupDestination Update a backup destination
	// (PATCH /backups/destinations/{destinationId})
	UpdateBackupDestination(c *gin.Context, destinationId BackupDestinationId)
	// RunBackupNow Trigger an immediate backup run
	// (POST /backups/destinations/{destinationId}/run)
	RunBackupNow(c *gin.Context, destinationId BackupDestinationId)
	// ListBackupRuns List backup runs for a destination
	// (GET /backups/destinations/{destinationId}/runs)
	ListBackupRuns(c *gin.Context, destinationId BackupDestinationId, params ListBackupRunsParams)
	// TestBackupDestination Test a backup destination's connectivity
	// (POST /backups/destinations/{destinationId}/test)
	TestBackupDestination(c *gin.Context, destinationId BackupDestinationId)
	// ListBackupProviders List available backup providers
	// (GET /backups/providers)
	ListBackupProviders(c *gin.Context)
	// GetBackupRun Get a single backup run by ID
	// (GET /backups/runs/{runId})
	...
	// ListCredentialFiles List a credential's reference files
	// (GET /credentials/{credentialId}/files)
	ListCredentialFiles(c *gin.Context, credentialId CredentialId)
	// UploadCredentialFile Upload a reference file for a credential
	// (POST /credentials/{credentialId}/files)
	UploadCredentialFile(c *gin.Context, credentialId CredentialId)
	// DeleteCredentialFile Delete a credential reference image
	// (DELETE /credentials/{credentialId}/files/{fileId})
	DeleteCredentialFile(c *gin.Context, credentialId CredentialId, fileId DocumentFileId)
	// GetCredentialFile Download a credential reference image
	// (GET /credentials/{credentialId}/files/{fileId})
	GetCredentialFile(c *gin.Context, credentialId CredentialId, fileId DocumentFileId)
	...
	// GetCurrentFlightSession Get current flight session
	// (GET /flight-sessions/current)
	GetCurrentFlightSession(c *gin.Context)
	// RecordFlightSessionEvent Record a flight session event
	...
	// ResendSignatureRequest Resend or regenerate a pending signature request
	...
	// RevokeSignatureRequest Revoke a pending signature request
	...
	// VoidFlightSignature Void a completed signature
	...
	// ListImports List import history
	// (GET /imports)
	...
	// ImportDataJSON Restore a NinerLog JSON backup
	// (POST /imports/json)
	ImportDataJSON(c *gin.Context)
	...
	// ListLicenseFiles List a licence's reference files
	// (GET /licenses/{licenseId}/files)
	ListLicenseFiles(c *gin.Context, licenseId LicenseId)
	// UploadLicenseFile Upload a reference file for a licence
	// (POST /licenses/{licenseId}/files)
	UploadLicenseFile(c *gin.Context, licenseId LicenseId)
	// DeleteLicenseFile Delete a licence reference image
	// (DELETE /licenses/{licenseId}/files/{fileId})
	DeleteLicenseFile(c *gin.Context, licenseId LicenseId, fileId DocumentFileId)
	...
	// CreateClassRating Add class rating to license
	// (POST /licenses/{licenseId}/ratings)
	CreateClassRating(c *gin.Context, licenseId LicenseId)
	// DeleteClassRating Delete class rating
	...
	// GetFlightTrends Get monthly flight trends
	// (GET /reports/trends)
	GetFlightTrends(c *gin.Context, params GetFlightTrendsParams)
	// GetPublicSignatureInfo Get public signing info for a token
	// (GET /sign/{token})
	...
	// DeleteMyBaseline Remove the user's initial hours snapshot
	// (DELETE /users/me/baseline)
	DeleteMyBaseline(c *gin.Context)
	// GetMyBaseline Get the user's initial hours snapshot (baseline)
	// (GET /users/me/baseline)
	GetMyBaseline(c *gin.Context)
	// PutMyBaseline Create or replace the user's initial hours snapshot
...
func (siw *ServerInterfaceWrapper) DeleteAnnouncement(c *gin.Context) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "announcementId", c.Param("announcementId"), &announcementId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: "uuid", ValueIsUnescaped: true})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) GetAirport(c *gin.Context) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "icaoCode", c.Param("icaoCode"), &icaoCode, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: "", ValueIsUnescaped: true})
	if err != nil {
...
// ListWebauthnCredentials operation middleware
func (siw *ServerInterfaceWrapper) ListWebauthnCredentials(c *gin.Context) {
	...
	siw.Handler.ListWebauthnCredentials(c)
}

// DeleteWebauthnCredential operation middleware
func (siw *ServerInterfaceWrapper) DeleteWebauthnCredential(c *gin.Context) {
	...
	siw.Handler.DeleteWebauthnCredential(c, credentialId)
}

// WebauthnLoginOptions operation middleware
func (siw *ServerInterfaceWrapper) WebauthnLoginOptions(c *gin.Context) {
	...
	siw.Handler.WebauthnLoginOptions(c)
}

// WebauthnLoginVerify operation middleware
func (siw *ServerInterfaceWrapper) WebauthnLoginVerify(c *gin.Context) {
	...
	siw.Handler.WebauthnLoginVerify(c)
}

// WebauthnRegisterOptions operation middleware
func (siw *ServerInterfaceWrapper) WebauthnRegisterOptions(c *gin.Context) {
	...
	siw.Handler.WebauthnRegisterOptions(c)
}

// WebauthnRegisterVerify operation middleware
func (siw *ServerInterfaceWrapper) WebauthnRegisterVerify(c *gin.Context) {
	...
	siw.Handler.WebauthnRegisterVerify(c)
}

// ListBackupDestinations operation middleware
func (siw *ServerInterfaceWrapper) ListBackupDestinations(c *gin.Context) {
	...
	siw.Handler.ListBackupDestinations(c)
}

// CreateBackupDestination operation middleware
func (siw *ServerInterfaceWrapper) CreateBackupDestination(c *gin.Context) {
	...
	siw.Handler.CreateBackupDestination(c)
}

// DeleteBackupDestination operation middleware
func (siw *ServerInterfaceWrapper) DeleteBackupDestination(c *gin.Context) {

	var err error
	_ = err

	// ------------- Path parameter "destinationId" -------------
	var destinationId BackupDestinationId

	err = runtime.BindStyledParameterWithOptions("simple", "destinationId", c.Param("destinationId"), &destinationId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: "uuid", ValueIsUnescaped: true})
	if err != nil {
		siw.ErrorHandler(c, fmt.Errorf("Invalid format for parameter destinationId: %w", err), http.StatusBadRequest)
		return
	}
	...
	siw.Handler.DeleteBackupDestination(c, destinationId)
}

// GetBackupDestination operation middleware
func (siw *ServerInterfaceWrapper) GetBackupDestination(c *gin.Context) {
	...
	siw.Handler.GetBackupDestination(c, destinationId)
}

// UpdateBackupDestination operation middleware
func (siw *ServerInterfaceWrapper) UpdateBackupDestination(c *gin.Context) {
	...
	siw.Handler.UpdateBackupDestination(c, destinationId)
}

// RunBackupNow operation middleware
func (siw *ServerInterfaceWrapper) RunBackupNow(c *gin.Context) {
	...
	siw.Handler.RunBackupNow(c, destinationId)
}

// ListBackupRuns operation middleware
func (siw *ServerInterfaceWrapper) ListBackupRuns(c *gin.Context) {
	...
	siw.Handler.ListBackupRuns(c, destinationId, params)
}

// TestBackupDestination operation middleware
func (siw *ServerInterfaceWrapper) TestBackupDestination(c *gin.Context) {
	...
	siw.Handler.TestBackupDestination(c, destinationId)
}

// ListBackupProviders operation middleware
func (siw *ServerInterfaceWrapper) ListBackupProviders(c *gin.Context) {
	...
	siw.Handler.ListBackupProviders(c)
}

// GetBackupRun operation middleware
func (siw *ServerInterfaceWrapper) GetBackupRun(c *gin.Context) {
	...
	siw.Handler.GetBackupRun(c, runId)
}
...
func (siw *ServerInterfaceWrapper) DeleteContact(c *gin.Context) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "contactId", c.Param("contactId"), &contactId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: "uuid", ValueIsUnescaped: true})
	if err != nil {
...
// ListCredentialFiles operation middleware
func (siw *ServerInterfaceWrapper) ListCredentialFiles(c *gin.Context) {
	...
	siw.Handler.ListCredentialFiles(c, credentialId)
}

// UploadCredentialFile operation middleware
func (siw *ServerInterfaceWrapper) UploadCredentialFile(c *gin.Context) {
	...
	siw.Handler.UploadCredentialFile(c, credentialId)
}

// DeleteCredentialFile operation middleware
func (siw *ServerInterfaceWrapper) DeleteCredentialFile(c *gin.Context) {
	...
	siw.Handler.DeleteCredentialFile(c, credentialId, fileId)
}

// GetCredentialFile operation middleware
func (siw *ServerInterfaceWrapper) GetCredentialFile(c *gin.Context) {
	...
	siw.Handler.GetCredentialFile(c, credentialId, fileId)
}
...
func (siw *ServerInterfaceWrapper) ExportFlightsPDF(c *gin.Context) {
	...
	err = runtime.BindQueryParameterWithOptions("form", true, false, "page_size", c.Request.URL.Query(), &params.PageSize, runtime.BindQueryParameterOptions{Type: "string", Format: ""})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) GetFlightSignature(c *gin.Context) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "signatureId", c.Param("signatureId"), &signatureId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: "uuid", ValueIsUnescaped: true})
	if err != nil {
...
// ImportDataJSON operation middleware
func (siw *ServerInterfaceWrapper) ImportDataJSON(c *gin.Context) {
...
func (siw *ServerInterfaceWrapper) GetImport(c *gin.Context) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "importId", c.Param("importId"), &importId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: "uuid", ValueIsUnescaped: true})
	if err != nil {
...
// ListLicenseFiles operation middleware
func (siw *ServerInterfaceWrapper) ListLicenseFiles(c *gin.Context) {
	...
	siw.Handler.ListLicenseFiles(c, licenseId)
}

// UploadLicenseFile operation middleware
func (siw *ServerInterfaceWrapper) UploadLicenseFile(c *gin.Context) {
	...
	siw.Handler.UploadLicenseFile(c, licenseId)
}

// DeleteLicenseFile operation middleware
func (siw *ServerInterfaceWrapper) DeleteLicenseFile(c *gin.Context) {
	...
	siw.Handler.DeleteLicenseFile(c, licenseId, fileId)
}

// GetLicenseFile operation middleware
func (siw *ServerInterfaceWrapper) GetLicenseFile(c *gin.Context) {
...
func (siw *ServerInterfaceWrapper) DeleteClassRating(c *gin.Context) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "ratingId", c.Param("ratingId"), &ratingId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: "uuid", ValueIsUnescaped: true})
	if err != nil {
...
func RegisterHandlersWithOptions(router gin.IRouter, si ServerInterface, options GinServerOptions) {
	...
	router.POST(options.BaseURL+"/auth/webauthn/register/options", wrapper.WebauthnRegisterOptions)
	router.POST(options.BaseURL+"/auth/webauthn/register/verify", wrapper.WebauthnRegisterVerify)
	router.POST(options.BaseURL+"/auth/webauthn/login/options", wrapper.WebauthnLoginOptions)
	router.POST(options.BaseURL+"/auth/webauthn/login/verify", wrapper.WebauthnLoginVerify)
	router.GET(options.BaseURL+"/auth/webauthn/credentials", wrapper.ListWebauthnCredentials)
	router.DELETE(options.BaseURL+"/auth/webauthn/credentials/:credentialId", wrapper.DeleteWebauthnCredential)
	...
	router.GET(options.BaseURL+"/licenses/:licenseId/files", wrapper.ListLicenseFiles)
	router.POST(options.BaseURL+"/licenses/:licenseId/files", wrapper.UploadLicenseFile)
	router.DELETE(options.BaseURL+"/licenses/:licenseId/files/:fileId", wrapper.DeleteLicenseFile)
	router.GET(options.BaseURL+"/licenses/:licenseId/files/:fileId", wrapper.GetLicenseFile)
	...
	router.GET(options.BaseURL+"/credentials/:credentialId/files", wrapper.ListCredentialFiles)
	router.POST(options.BaseURL+"/credentials/:credentialId/files", wrapper.UploadCredentialFile)
	router.DELETE(options.BaseURL+"/credentials/:credentialId/files/:fileId", wrapper.DeleteCredentialFile)
	router.GET(options.BaseURL+"/credentials/:credentialId/files/:fileId", wrapper.GetCredentialFile)
	...
	router.DELETE(options.BaseURL+"/backups/destinations/:destinationId", wrapper.DeleteBackupDestination)
	router.GET(options.BaseURL+"/backups/destinations/:destinationId", wrapper.GetBackupDestination)
	router.PATCH(options.BaseURL+"/backups/destinations/:destinationId", wrapper.UpdateBackupDestination)
	router.POST(options.BaseURL+"/backups/destinations/:destinationId/test", wrapper.TestBackupDestination)
