...
func (siw *ServerInterfaceWrapper) DeleteBackupDestination(c *gin.Context) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "destinationId", c.Param("destinationId"), &destinationId, runtime.BindStyledParameterOptions{Explode: false, Required: true})
	if err != nil {
