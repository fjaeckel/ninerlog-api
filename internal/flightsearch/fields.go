...
var Fields = []Field{
	...
	{Name: "picusTime", Aliases: []string{"picus"}, Type: FieldDuration, Column: "picus_time", Description: "PIC under supervision time"},
	{Name: "spicTime", Aliases: []string{"spic"}, Type: FieldDuration, Column: "spic_time", Description: "Student PIC time"},
	{Name: "examinerTime", Aliases: []string{"examiner"}, Type: FieldDuration, Column: "examiner_time", Description: "Examiner time"},
	{Name: "reliefTime", Aliases: []string{"relief"}, Type: FieldDuration, Column: "relief_time", Description: "Cruise relief co-pilot time"},
